<#
    ...
    .DESCRIPTION
    Install:   PowerShell.exe -ExecutionPolicy Bypass -Command .\INSTALL-DefenderApplicationGuard.ps1 -install
    Uninstall: PowerShell.exe -ExecutionPolicy Bypass -Command .\INSTALL-DefenderApplicationGuard.ps1 -uninstall
    Detect:    PowerShell.exe -ExecutionPolicy Bypass -Command .\INSTALL-DefenderApplicationGuard.ps1 -detect
...
$WindowsFeature = "Windows-Defender-ApplicationGuard"
